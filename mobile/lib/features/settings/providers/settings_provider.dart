...
class SettingsNotifier extends StateNotifier<SettingsState> {
  ...
  SettingsNotifier(this._userRepo, this._ref) : super(const SettingsState.initial());
  ...
  Future<void> changePassword({
    ...
    try {
      ...
      state = const SettingsState(isSubmitting: false, isSuccess: true, errorMessage: null);
    } catch (e) {
      state = SettingsState(isSubmitting: false, isSuccess: false, errorMessage: e.toString());
    }
  }
